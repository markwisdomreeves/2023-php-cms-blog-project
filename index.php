...
" class = 'img-fluid' alt = 'Blog Article Img' />
        ...
        <h2 style = 'padding: 10px;'>No Blog Article Found</h2>
        </div>
        <?php
    }
    ?>
    ...
    if ( $total_num_of_posts > $limit ) {
        ...
        <?php for ( $i = 1; $i <= $pages; $i++ ) {
            ?>
            <li class = 'page-item'>
            <a href = 'index.php?page=<?php echo $i; ?>' class = 'page-link' style = 'color: #18151f;'>
            <?php echo $i;
            ?>
            </a>
            </li>
            ...
            <?php }
            ?>
            <!-- End of showing pagination btn allowing to the number of posts -->
            </div>
